    ...
    <SiteLayout>
      <section className="bg-muted/40">
        <div className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 lg:px-8 lg:py-24">
          <span className="text-sm font-semibold uppercase tracking-wider text-primary">À propos</span>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-6 md:grid-cols-3">
          {VALUES.map((v) => (
            <div key={v.t} className="rounded-2xl bg-card p-8 shadow-[var(--shadow-card)] ring-1 ring-border/60">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-secondary-soft">
      ...
      <section className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 space-y-6">
          {TIMELINE.map((e) => (
            <div key={e.y} className="flex gap-5 rounded-2xl bg-card p-6 shadow-[var(--shadow-card)] ring-1 ring-border/60">
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="rounded-3xl p-10 text-center sm:p-16" style={{ background: "var(--gradient-trust)" }}>
          <Users className="mx-auto h-12 w-12 text-secondary-foreground" />
