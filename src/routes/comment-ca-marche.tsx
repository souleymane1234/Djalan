    ...
    <SiteLayout>
      <section className="bg-muted/40">
        <div className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 lg:px-8 lg:py-24">
          <span className="reveal-up text-sm font-semibold uppercase tracking-wider text-primary">Comment ça marche</span>
          <h1 className="reveal-up mt-3 font-display text-4xl font-extrabold tracking-tight sm:text-5xl" style={{ animationDelay: "120ms" }}>Voyagez en 4 étapes</h1>
          <p className="reveal-up mt-6 text-lg text-muted-foreground" style={{ animationDelay: "220ms" }}>De la recherche au voyage, tout se passe sur votre téléphone.</p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="space-y-6 lg:space-y-10">
          {STEPS.map((s, i) => (
            <div key={s.t} className={`reveal-up hover-lift grid items-center gap-8 rounded-3xl bg-card p-8 shadow-[var(--shadow-card)] ring-1 ring-border/60 lg:grid-cols-2 lg:p-12 ${i % 2 ? "lg:[&>div:first-child]:order-2" : ""}`} style={{ animationDelay: `${100 + i * 90}ms` }}>
              <div>
              ...
              <div className="shimmer-shell flex aspect-video items-center justify-center rounded-2xl" style={{ background: i % 2 ? "var(--gradient-trust)" : "var(--gradient-hero)" }}>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-3">
          {ADV.map((a, i) => (
            <div key={a.t} className="reveal-up hover-lift rounded-2xl bg-card p-6 shadow-[var(--shadow-card)] ring-1 ring-border/60" style={{ animationDelay: `${100 + i * 80}ms` }}>
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          <div className="reveal-up hover-lift rounded-2xl border-2 border-dashed border-border p-8">
          ...
          <div className="reveal-up hover-lift shimmer-shell rounded-2xl p-8 text-secondary-foreground" style={{ background: "var(--gradient-trust)", animationDelay: "140ms" }}>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 text-center sm:px-6 lg:px-8">
        <Button asChild size="lg" className="hover-lift hover-spark hover-icon-nudge h-14 rounded-full px-8 text-base shadow-[var(--shadow-elevated)]">
